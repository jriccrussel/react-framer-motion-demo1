...
// Step 1 - Setup NavigationTwo Component
...
// Step 3 - Parent Component|App.js -->"<Header/>" & "<NavigationTwo/>" = "<Header toggleMenu={toggleMenu} setToggleMenu={setToggleMenu}/>" && "<NavigationTwo toggleMenu={toggleMenu} setToggleMenu={setToggleMenu}/>"
// Step 4 - "<Header/>" --> "<Menu onClick={() => setToggleMenu(!toggleMenu)}/>"
// Step 5 - Add "{toggleMenu && <Nav>...</Nav>}" && <CloseNav onClick={() => setToggleMenu(!toggleMenu)} />
