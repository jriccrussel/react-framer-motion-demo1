...
// Step 3 - Parent Component / App.js --> on the "<Header/>" and "<NavigationTwo/>"  add "toggleMenu={toggleMenu}" && "setToggleMenu={setToggleMenu}" as prop = "<Header toggleMenu={toggleMenu} setToggleMenu={setToggleMenu}/>", "<NavigationTwo toggleMenu={toggleMenu} setToggleMenu={setToggleMenu}/>"
