...
// Step 2 - On the Parent Component / App.js before return add "const [toggleMenu, setToggleMenu] = useState(false)" the state should be the same so the toggle menu would run
// Step 3 - On the same Parent Component / App.js --> on the "<Header/>" add "toggleMenu={toggleMenu}" && "setToggleMenu={setToggleMenu}" as prop --> "<Header toggleMenu={toggleMenu} setToggleMenu={setToggleMenu}/>"
