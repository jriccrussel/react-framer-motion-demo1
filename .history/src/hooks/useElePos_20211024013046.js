...
// Step 2 - Header.js --> before return --> Add useState "const hamburger = useRef(null)"
// Step 3 - Header.js --> before return --> Add custom hook "const position = useElePos(hamburger)"
...
// Step 8 - Header.js --> before return --> Add "const menuHover = () => {...}"
// Step 9 - Header.js --> Add inline prop "onMouseEnter={menuHover}" === "<Menu onMouseEnter={menuHover}/>"
// Step 10 - App.js --> "const darkTheme = {...}" && "const lightTheme = {...}" Add "left: `${menuPosition.x}px`, top: `${menuPosition.y}px`," 
// Step 11 - context.js ---> sa "export const GlobalProvider = ({ children }) => {...}" sa "const [state, dispatch]..." ---> Add "locked" sa "cursorStyles" === cursorStyles: ["pointer", "hovered"]"
// 
// 
// 
